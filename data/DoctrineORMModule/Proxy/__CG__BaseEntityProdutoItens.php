 ...
 */
class ProdutoItens extends \Base\Entity\ProdutoItens implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'descricao', 'valor', 'produto');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProdutoItens $proxy) {
